...
namespace Xylene\Support\Doctrine;
...
class ConnectionFactory
{
    ...
    public function createConnection(array $params, ?Configuration $config = null, ?EventManager $eventManager = null, array $mappingTypes = [])
    {
        ...
        if (isset($params['connection_override_options'])) {
            \trigger_deprecation('doctrine/doctrine-bundle', '2.4', 'The "connection_override_options" connection parameter is deprecated');
    ...
    private function getDatabasePlatform(Connection $connection): AbstractPlatform
    {
        try {
            ...
            throw new DBALException('An exception occurred while establishing a connection to figure out your platform version.'.\PHP_EOL."You can circumvent this by setting a 'server_version' configuration value".\PHP_EOL.\PHP_EOL.'For further information have a look at:'.\PHP_EOL.'https://github.com/doctrine/DoctrineBundle/issues/673', 0, $driverException);
        }
    }
